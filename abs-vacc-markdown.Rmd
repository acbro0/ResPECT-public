...
vac_count$predictors <- c("vaccinated vs. unvaccinated", 
                    "male vs. female", "2014 vs. 2013", "2015 vs. 2013", 
...
vac_count$predictors <- factor(vac_count$predictors, levels=rev(c("non-mandatory sites vs. mandatory sites",
                                                                  "vaccinated vs. unvaccinated", 
                                                      "male vs. female", "URI exposure (10% increments)",
                                                      "age (10 year increments)", 
                                                      "2014 vs. 2013", "2015 vs. 2013")))

vac_zero$predictors <-  c("vaccinated vs. unvaccinated", 
                    "male vs. female", "2014 vs. 2013", "2015 vs. 2013", "URI exposure (10% increments)", 
                    "age (10 year increments)", 
                    "non-mandatory sites vs. mandatory sites")
...
vac_zero$predictors <- factor(vac_zero$predictors, levels=rev(c("non-mandatory sites vs. mandatory sites",
                                                                  "vaccinated vs. unvaccinated", 
                                                      "male vs. female", "URI exposure (10% increments)",
                                                      "age (10 year increments)", 
                                                      "2014 vs. 2013", "2015 vs. 2013")))
...
vac$predictors <- c("non-mandatory sites vs. mandatory sites", 
                    "male vs. female", "2014 vs. 2013", "2015 vs. 2013", "URI exposure (10% increments)", 
                    "age (10 year increments)")
...
vac$predictors <- factor(vac$predictors, levels=rev(c("non-mandatory sites vs. mandatory sites", 
                    "male vs. female", "URI exposure (10% increments)", 
                    "age (10 year increments)", 
                    "2014 vs. 2013", "2015 vs. 2013")))
