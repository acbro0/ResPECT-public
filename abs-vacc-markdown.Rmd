...
vac_count$predictors <- factor(vac_count$predictors, levels=rev(c("vaccinated vs. unvaccinated", 
                                                      "non-mandatory sites vs. mandatory sites",
...
pushViewport(viewport(layout = 
                        ...
                        widths = unit(c(1.6, 1), "null"))))

print(vz, vp = viewport(layout.pos.row = 1, layout.pos.col = 1))
print(vc, vp = viewport(layout.pos.row = 1, layout.pos.col = 2))
```
...
vac$predictors <- c("non-mandatory sites vs. mandatory sites", 
                    "male vs. female", "2014 vs. 2013", "2015 vs. 2013", "URI exposure (10% increments)", 
                    "hand hygiene: usually vs. never", "hand hygiene: sometimes vs. never",
                    "hand hygiene: unknown vs. never", "age (10 year increments)")
...
vac$predictors <- factor(vac$predictors, levels=rev(c("non-mandatory sites vs. mandatory sites", 
                    ...
                    "age (10 year increments)", 
                    "2014 vs. 2013", "2015 vs. 2013", 
                    "hand hygiene: usually vs. never", 
                    "hand hygiene: sometimes vs. never",
                    "hand hygiene: unknown vs. never")))
