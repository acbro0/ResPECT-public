...
```{r}
plot(ARI_itt_adjfit$analyses[[1]])
```

ARI_pp_fit

```{r}
plot(ARI_pp_fit$analyses[[1]])
```

ARI_pp_adjfit

```{r}
plot(ARI_pp_adjfit$analyses[[1]])
```
...
```{r}
plot(LCRI_itt_fit$analyses[[1]])
```

LCRI_itt_adjfit

```{r}
plot(LCRI_itt_adjfit$analyses[[1]])
```

LCRI_pp_fit

```{r}
plot(LCRI_pp_fit$analyses[[1]])
```

LCRI_pp_adjfit

```{r}
plot(LCRI_pp_adjfit$analyses[[1]])
```
...
```{r}
plot(LDI_itt_fit$analyses[[1]])
```

LDI_itt_adjfit

```{r}
plot(LDI_itt_adjfit$analyses[[1]])
```

LDI_pp_fit

```{r}
plot(LDI_pp_fit$analyses[[1]])
```

LDI_pp_adjfit

```{r}
plot(LDI_pp_adjfit$analyses[[1]])
```
...
```{r}
plot(ILI_itt_fit$analyses[[1]])
```

ILI_itt_adjfit

```{r}
plot(ILI_itt_adjfit$analyses[[1]])
```

ILI_pp_fit

```{r}
plot(ILI_pp_fit$analyses[[1]])
```

ILI_pp_adjfit

```{r}
plot(ILI_pp_adjfit$analyses[[1]])
